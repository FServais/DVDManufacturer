...
iptables -t filter -A FORWARD -j DROP -d 172.16.9.2
...
# Deny otherwise
iptables -t filter -A FORWARD -j LOG --log-prefix "[FORW] DROP : " -d 172.16.8.0/24
iptables -t filter -A FORWARD -j DROP -d 172.16.8.0/24
